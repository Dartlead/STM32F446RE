...
__attribute__((section(".vector_table"))) void (* const __vector_table[])(void) = {
	...
	, TIM1_TRG_COM_TIM11_handler /* Timer 1 Trig & Communication/Timer 11 Global 0-15 (settable)     0x0000 00A8 */
	...
	, TIM8_TRG_COM_TIM14_handler /* Timer8 Trig & Communication/Timer14 Global   0-15 (settable)     0x0000 00F4 */
	...
	, OTG_HS_EP1_OUT_handler     /* USB OTG High-Speed End Point 1 Out Global    0-15 (settable)     0x0000 0168 */
	, OTG_HS_EP1_IN_handler      /* USB OTG High-Speed End Point 1 In Global     0-15 (settable)     0x0000 016C */
	, OTG_HS_WKUP_handler        /* USB OTG High-Speed Wakeup                    0-15 (settable)     0x0000 0170 */
	, OTG_HS_handler             /* USB OTG High-Speed Global                    0-15 (settable)     0x0000 0174 */
